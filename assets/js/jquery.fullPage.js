    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            ...
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + '"><div class="icic_arrow_back ic_3x"></div></div><div class="' + SLIDES_ARROW_NEXT + '"><div class="icic_arrow_next ic_3x"></div></div>');
